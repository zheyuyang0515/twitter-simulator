...
var register_btn = document.querySelector("#registration");
var register_username_input = document.querySelector("#register_username");
var register_password_input = document.querySelector("#register_password");
if (register_btn) {
  register_btn.addEventListener("click", function () {
    if (register_username_input.value == "") {
      ...
      channel.push("registration", { username: register_username_input.value, password: register_password_input.value }).receive("register_success", function (_) {
        alert("Register Successfully!");window.location.replace("/");
      }).receive("register_failed", function (_) {
        alert("Register Failed: Username is exist. Please change another one!");
      });
...
var login_username_input = document.querySelector("#username");
var login_password_input = document.querySelector("#password");
var login_btn = document.querySelector("#login");
var valid_password = void 0;
var valid_username = void 0;
if (login_btn) {
  login_btn.addEventListener("click", function () {
    channel.push("login", { username: login_username_input.value, password: login_password_input.value }).receive("username_not_exist", function (_) {
      alert("Username not exist.");login_username_input.value = "";
      login_password_input.value = "";
    }).receive("password_incorrect", function (_) {
      alert("Password incorrect");login_password_input.value = "";
    }).receive("login_repeat", function (_) {
      alert("This user has loged in on another device.");
    }).receive("success", function (resp) {
      login_username_input.value = "";login_password_input.value = "";valid_username = resp["username"];valid_password = resp["password"];document.getElementById("login_page").style.display = "none";document.getElementById("main_page").style.display = "";document.getElementById("main_page_username").innerHTML = resp["username"];
    });
  });
}
...
if (logout_btn) {
  logout_btn.addEventListener("click", function () {
    ...
    if (confirmation == true) {
      channel.push("logout", { username: valid_username }).receive("success", function (_) {
        document.getElementById("messages").innerHTML = "";valid_username = "";document.getElementById("main_page").style.display = "none";document.getElementById("login_page").style.display = "";
      }).receive("user_offline", function (_) {
        valid_username = "";document.getElementById("main_page").style.display = "none";document.getElementById("login_page").style.display = "";
      }).receive("invalid_request", function (_) {
        alert("Invalid Request: Unauthorized Request.");
      });
    }
  });
}
var delete_account_btn = document.querySelector("#delete_account");
if (delete_account_btn) {
  delete_account_btn.addEventListener("click", function () {
    ...
    if (confirmation == true) {
      channel.push("delete_account", { username: valid_username, password: valid_password }).receive("success", function (_) {
        valid_username = "";document.getElementById("main_page").style.display = "none";document.getElementById("login_page").style.display = "";
      }).receive("username_not_exist", function (_) {
        alert("Invalid Request: Username Not Exist!");
      }).receive("password_incorrect", function (_) {
        alert("Invalid Request: Password Incorrect.");
      });
    }
  });
}
var mentions = document.querySelector("#mentioned");
var hashtags = document.querySelector("#hashtags");
var tweet_content = document.querySelector("#tweet_content");
var send_tweet_btn = document.querySelector("#send_tweet");
if (send_tweet_btn) {
  send_tweet_btn.addEventListener("click", function () {
    channel.push("send_tweet", { username: valid_username, content: tweet_content.value, hashtags: hashtags.value, mentions: mentions.value }).receive("success", function (_) {
      var messageItem = document.createElement("button");
...
var target_username = document.querySelector("#subscribe_input");
var subscribe_btn = document.querySelector("#subscribe");
if (subscribe_btn) {
  subscribe_btn.addEventListener("click", function () {
    channel.push("subscribe", { username: valid_username, target_username: target_username.value }).receive("success", function (_) {
      var messageItem = document.createElement("button");
      messageItem.className = "retweet_btn";
    ...
    }).receive("user_not_exist", function (_) {
      alert("User " + target_username.value + " Not Exist!");target_username.value = "";
      subscribe_btn.disabled = true;
    }).receive("invalid_request", function (_) {
      alert("Invalid Request: Unauthorized Request.");
    });
...
var search_hashtag_btn = document.querySelector("#search_hashtag");
var search_hashtag_input = document.querySelector("#search_hashtag_input");
if (search_hashtag_btn) {
  search_hashtag_btn.addEventListener("click", function () {
    channel.push("query_hashtag", { username: valid_username, hashtag: search_hashtag_input.value }).receive("invalid_request", function (_) {
      alert("Invalid Request: Unauthorized Request.");
    }).receive("success", function (results) {
      ...
      if (results.result.length == 0) {
        ...
        var _loop = function _loop() {
          ...
          messageItem.addEventListener("click", function () {
            ...
            if (comments != null) {
              channel.push("retweet", { username: valid_username, tweet_id: parseInt(messageItem.id), comments: comments }).receive("user_not_exist", function (_) {
...
var search_subscribed_btn = document.querySelector("#search_subscribed");
if (search_subscribed_btn) {
  search_subscribed_btn.addEventListener("click", function () {
    channel.push("query_subscribed", { username: valid_username }).receive("invalid_request", function (_) {
      alert("Invalid Request: Unauthorized Request.");
    }).receive("success", function (results) {
      if (results.result.length == 0) {
        alert("No Result.");
...
var search_mentioned_btn = document.querySelector("#search_mentioned");
if (search_mentioned_btn) {
  search_mentioned_btn.addEventListener("click", function () {
    channel.push("query_mentioned", { username: valid_username }).receive("invalid_request", function (_) {
      alert("Invalid Request: Unauthorized Request.");
    }).receive("success", function (results) {
      if (results.result.length == 0) {
        alert("No Result.");
...
channel.on("new_subscriber", function (payload) {
  var messageItem = document.createElement("button");
  messageItem.className = "retweet_btn";
  messageItem.innerText = "[" + Date() + "] " + "New Subscriber: " + payload.username + ".";
  messagesContainer.appendChild(messageItem);
});
channel.on("auto_subscribed_tweet", function (payload) {
  var messageItem = document.createElement("button");
  messageItem.className = "retweet_btn";
  ...
  messageItem.addEventListener("click", function () {
    var comments = prompt("Please write your comments:", "");
    if (comments != null) {
      channel.push("retweet", { username: valid_username, tweet_id: payload.tweet_id, comments: comments }).receive("user_not_exist", function (_) {
        alert("User Not Exist!");
      }).receive("invalid_request", function (_) {
        alert("Invalid Request: Unauthorized Request.");
      }).receive("success", function (resp) {
...
channel.on("auto_subscribed_retweet", function (payload) {
  var messageItem = document.createElement("button");
  messageItem.className = "retweet_btn";
  if (payload.comments == "") {
...
channel.on("auto_mentioned_tweet", function (payload) {
  var messageItem = document.createElement("button");
  messageItem.className = "retweet_btn";
  if (payload.hashtags != "" && payload.mentions != "") {
    messageItem.innerText = "[" + Date() + "] " + payload.username + ": " + payload.content + "(mentioned: " + payload.mentions + "; HashTags: " + payload.hashtags + ").";
